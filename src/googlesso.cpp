    ...
    : QOAuth2AuthorizationCodeFlow(parent)
{
    ...
    this->_configure_sso(scope);
    this->_load_tokens();
    this->_configure_signals_and_slots();
}
...
inline void GoogleSSO::_configure_sso(const QString& scope)
{
...
inline void GoogleSSO::_configure_signals_and_slots()
{
    // Namespaces
